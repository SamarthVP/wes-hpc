...
print(DoHeatmap(object = seurat.object.f, features = top_genes_by_cluster_for_heatmap$gene, label = F, group.bar = T, raster = F, angle = 0) + NoLegend() + ggtitle("Cell clusters"))
dev.off()
...
###############################################################
### PUGHLAB/CRESCENT/RUNS_SEURAT_V3 GITHUB VERSION 8baf1c0 ###
##############################################################
